...
Execute the following commands, replacing `endpoint-batch-fashion-1` with the name you choose for your endpoint.

```
az ml batch-endpoint create -f fashion-mnist/batch-endpoint/cloud/endpoint-1/endpoint.yml --name endpoint-batch-fashion-1
az ml batch-deployment create -f fashion-mnist/batch-endpoint/cloud/endpoint-1/deployment.yml --set-default
```


## Invoke the endpoints

Execute the following commands, replacing `endpoint-batch-fashion` with the name you choose for your endpoint.

```
az ml batch-endpoint invoke --input-local-path fashion-mnist/batch-endpoint/sample-request --name endpoint-batch-fashion
```
